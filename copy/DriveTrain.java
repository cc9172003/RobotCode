...
public class DriveTrain {
	...
	private LinearWinch lw;
	private DashBoard db;
	
	private double armMoveSpeed;
//	private boolean willStop;
	
	public DriveTrain(Joystick joyStick,DashBoard dbx){
		tflag=false;
		j = joyStick;
...
//			willStop=true;
    	...
    	else if(j.getRawButton(3)){//a little too fast...
